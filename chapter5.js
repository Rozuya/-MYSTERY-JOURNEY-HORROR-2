...
Après tout ce que tu as vécu depuis le début de cette nuit, tu sais que cet appel sera différent.
...
Mais derrière chaque porte se trouve une version différente de ton histoire. »`,
    ...
    choices:[
        {
            text:"🩸 Chercher toute la vérité",
            next:"truth_final"
        },
        {
            text:"🏨 Retourner dans l'hôtel",
            next:"hotel_path"
        },
        {
            text:"🪞 Chercher ton autre version",
            next:"other_path"
        }
    ]
},
...
« À MOINS QU'IL NE DÉCOUVRE LA VÉRITÉ. »`,
    ...
    choices:[
        ...
        {
            text:"📼 Rechercher l'enregistrement original",
            next:"ending_cassette",
            end:"cassette"
        },
        {
            text:"🚪 Quitter les archives",
            next:"ending_after_blackwood",
            end:"after_blackwood"
        }
    ]
},
...
« TU AS CHOISI LE SILENCE. »`,
    ...
    choices:[
        {
            text:"🔇 Ne plus répondre",
            next:"ending_silence",
            end:"silence"
        },
        {
            text:"🚗 Continuer vers la ville",
            next:"offline_path"
        },
        {
            text:"🏨 Retourner au Last Call",
            next:"hotel_path"
        }
    ]
},
...
« UNE SEULE PORTE MÈNE À LA SORTIE. »`,
    ...
    choices:[
        {
            text:"🏨 Rester dans l'hôtel",
            next:"ending_hotel",
            end:"hotel"
        },
        {
            text:"🚪 Chercher la porte de sortie",
            next:"offline_path"
        },
        {
            text:"📞 Décrocher l'un des téléphones",
            next:"answer_path"
        }
    ]
},
...
« Je suis celui qui a continué après Blackwood. »`,
    ...
    choices:[
        {
            text:"🪞 T'approcher du reflet",
            next:"ending_other",
            end:"other"
        },
        {
            text:"🪞 Détruire le miroir",
            next:"ending_mirror",
            end:"mirror"
        },
        {
            text:"🚪 Partir sans le regarder",
            next:"offline_path"
        }
    ]
},
...
Mais quelque chose apparaît dans ton rétroviseur.`,
    ...
    choices:[
        {
            text:"🚗 Continuer sans regarder",
            next:"ending_offline",
            end:"offline"
        },
        {
            text:"👀 Regarder le rétroviseur",
            next:"ending_last_survivor",
            end:"last_survivor"
        },
        {
            text:"📞 Vérifier ton téléphone",
            next:"ending_tomorrow",
            end:"tomorrow"
        }
    ]
},
